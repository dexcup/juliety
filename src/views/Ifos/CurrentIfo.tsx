    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy WWC and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get WWC-BNB LP tokens by adding WWC and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://dex.winnow.me/#/swap" mr="16px">
              {TranslateString(1060, 'Buy WWC')}
            </LinkExternal>
            <LinkExternal href="https://dex.winnow.me/#/add/BNB/0x219Bff72Cc73F266B4AEBcd6011358d2E612646b">
              {TranslateString(1062, 'Get LP tokens')}
            </LinkExternal>
          </Flex>
          <Heading mb="16px">{TranslateString(600, 'During Sale')}:</Heading>
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your WWC-LP tokens to buy the IFO tokens')}</li>
          </List>
